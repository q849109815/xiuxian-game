...
const EX = {
  ...
  HOT_UPDATE: {
    enabled: true,
    version: '20260926d',      /* 主版本号，改这个会强制全量刷新缓存 */
    /* 资源清单：path / ver / size(KB) */
    manifest: [
      { p: 'css/style.css', ver: '20260926d', size: 0 },
      { p: 'js/net.js', ver: '20260926d', size: 0 },
      { p: 'js/config.js', ver: '20260926d', size: 0 },
      { p: 'js/engine.js', ver: '20260926d', size: 0 },
      { p: 'js/battle.js', ver: '20260926d', size: 0 },
      { p: 'js/ui.js', ver: '20260926d', size: 0 },
      { p: 'js/main.js', ver: '20260926d', size: 0 },
      { p: 'js/audio.js', ver: '20260926d', size: 0 },
    ],
  },

...
const EX = {
  ...
  skills: [
    { id: 'wenyadan', n: '温压弹', icon: '🔥', img: 'assets/icon/sk_wenyadan.jpg', kind: 'active', el: '火', max: 10, cd: 6.0,
      desc: '高温高压爆炸，大范围群体伤害', up: '每级 +范围 +伤害', mods: { blastR: 96, blastMul: 1.6 } },
    { id: 'ganbingdan', n: '干冰弹', icon: '❄️', img: 'assets/icon/sk_ganbingdan.jpg', kind: 'active', el: '冰', max: 10, cd: 7.0,
      desc: '冻结减速全场僵尸', up: '每级 +冻结时长 +范围', mods: { freeze: 1.6, freezeR: 120 } },
    { id: 'diancichuan', n: '电磁穿刺', icon: '⚡', img: 'assets/icon/sk_diancichuan.jpg', kind: 'active', el: '电', max: 10, cd: 5.5,
    ...
    { id: 'ranyoudan', n: '燃油弹', icon: '🛢️', img: 'assets/icon/sk_ranyoudan.jpg', kind: 'active', el: '火', max: 10, cd: 6.5,
      desc: '抛洒燃油，地面持续燃烧', up: '每级 +燃烧范围', mods: { burnR: 130, burnDps: 0.9 } },
    { id: 'gaonengshexian', n: '高能射线', icon: '📡', img: 'assets/icon/sk_gaonengshexian.jpg', kind: 'active', el: '电', max: 10, cd: 5.0,

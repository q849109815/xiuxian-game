...
const EX = {
  ...
  levels: [
    ...
    { id: '3-10', ch: 3, n: 'BOSS·开垦者&感染母体', waves: 20, pool: ['putong', 'jipao', 'zibao', 'zhongjia', 'du'], per: [19, 30], mul: 3.23,
      cond: 'bossAll', boss: ['kaiken', 'mama'], rw: { gold: 988, M04: 10 }, unlock: '3-9', scene: 'wasteland' },
    ...
    { id: '4-10', ch: 4, n: 'BOSS·开垦者', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan'], per: [22, 35], mul: 4.08,
      cond: 'boss', boss: 'kaiken', rw: { gold: 1292, M05: 12 }, unlock: '4-9', scene: 'factory' },
    ...
    { id: '5-10', ch: 5, n: 'BOSS·巢穴之母', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun'], per: [25, 40], mul: 4.93,
      cond: 'boss', boss: 'chaoxue', rw: { gold: 1596, M01: 15 }, unlock: '5-9', scene: 'tunnel' },
    ...
    { id: '6-10', ch: 6, n: 'BOSS·深渊领主', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie'], per: [28, 45], mul: 5.78,
      cond: 'boss', boss: 'shenyuan', rw: { gold: 1900, M02: 18 }, unlock: '6-9', scene: 'field' },
    ...
    { id: '7-10', ch: 7, n: 'BOSS·暴食者', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing'], per: [31, 50], mul: 6.62,
      cond: 'boss', boss: 'baoshi', rw: { gold: 2204, M03: 20 }, unlock: '7-9', scene: 'snow' },
    ...
    { id: '8-10', ch: 8, n: 'BOSS·修道士&深渊领主', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [34, 55], mul: 7.47,
      cond: 'bossAll', boss: ['xiudao', 'shenyuan'], rw: { gold: 2508, M04: 22 }, unlock: '8-9', scene: 'city' },
    ...
    { id: '9-10', ch: 9, n: 'BOSS·修道士', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [37, 60], mul: 8.32,
      cond: 'boss', boss: 'xiudao', rw: { gold: 2812, M05: 25 }, unlock: '9-9', scene: 'wasteland' },
    ...
    { id: '10-10', ch: 10, n: 'BOSS·尸王', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [40, 65], mul: 9.16,
      cond: 'boss', boss: 'shiwang', rw: { gold: 3116, M01: 28 }, unlock: '10-9', scene: 'factory' },
  ],
  ...
  bosses: [
    ...
    { id: 'kaiken', n: '开垦者', icon: '⛏️', img: 'assets/char/boss_kaiken.jpg', hp: 5200, spd: 20, dmg: 52, atkR: 60, def: 0.28,
    ...
    { id: 'chaoxue', n: '巢穴之母', icon: '🕸️', img: 'assets/char/boss_chaoxue.jpg', hp: 7800, spd: 18, dmg: 58, atkR: 130, def: 0.30,
    ...
    { id: 'shenyuan', n: '深渊领主', icon: '🔱', img: 'assets/char/boss_shenyuan.jpg', hp: 11500, spd: 24, dmg: 75, atkR: 170, def: 0.32,
    ...
    { id: 'baoshi', n: '暴食者', icon: '🍖', img: 'assets/char/boss_baoshi.jpg', hp: 16500, spd: 14, dmg: 88, atkR: 55, def: 0.38,
    ...
    { id: 'xiudao', n: '修道士', icon: '🕯️', img: 'assets/char/boss_xiudao.jpg', hp: 23000, spd: 28, dmg: 105, atkR: 200, def: 0.34,
    ...
    { id: 'shiwang', n: '尸王', icon: '👑', img: 'assets/char/boss_shiwang.jpg', hp: 32000, spd: 26, dmg: 130, atkR: 210, def: 0.40,

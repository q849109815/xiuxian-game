...
const EX = {
   ...
   * =================================================== */
  levels: [
    { id: '1-1', ch: 1, n: '废弃街道', waves: 20, pool: ['putong', 'jipao'], per: [13, 20], mul: 1.0,
      cond: 'clear', rw: { gold: 200, M02: 5 }, unlock: null, scene: 'city' },
    { id: '1-2', ch: 1, n: '停车场', waves: 20, pool: ['putong', 'jipao'], per: [13, 20], mul: 1.06,
      cond: 'clear', rw: { gold: 220, M02: 5 }, unlock: '1-1', scene: 'city' },
    { id: '1-3', ch: 1, n: '废墟大楼', waves: 20, pool: ['putong', 'jipao'], per: [13, 20], mul: 1.12,
      cond: 'clear', rw: { gold: 240, M02: 5 }, unlock: '1-2', scene: 'city' },
    { id: '1-4', ch: 1, n: '便利店', waves: 20, pool: ['putong', 'jipao'], per: [13, 20], mul: 1.18,
      cond: 'clear', rw: { gold: 260, M02: 5 }, unlock: '1-3', scene: 'city' },
    { id: '1-5', ch: 1, n: '天台哨所', waves: 20, pool: ['putong', 'jipao'], per: [13, 20], mul: 1.24,
      cond: 'clear', rw: { gold: 280, M02: 5 }, unlock: '1-4', scene: 'city' },
    { id: '1-6', ch: 1, n: '地下车库', waves: 20, pool: ['putong', 'jipao'], per: [13, 20], mul: 1.3,
      cond: 'clear', rw: { gold: 300, M02: 5 }, unlock: '1-5', scene: 'wasteland' },
    { id: '1-7', ch: 1, n: '街区巷战', waves: 20, pool: ['putong', 'jipao'], per: [13, 20], mul: 1.36,
      cond: 'clear', rw: { gold: 320, M02: 5 }, unlock: '1-6', scene: 'factory' },
    { id: '1-8', ch: 1, n: '加油站', waves: 20, pool: ['putong', 'jipao'], per: [13, 20], mul: 1.42,
      cond: 'clear', rw: { gold: 340, M02: 5 }, unlock: '1-7', scene: 'tunnel' },
    { id: '1-9', ch: 1, n: '学校操场', waves: 20, pool: ['putong', 'jipao'], per: [13, 20], mul: 1.48,
      cond: 'clear', rw: { gold: 360, M02: 5 }, unlock: '1-8', scene: 'field' },
    { id: '1-10', ch: 1, n: 'BOSS·巨型丧尸', waves: 20, pool: ['putong', 'jipao'], per: [13, 20], mul: 1.54,
      cond: 'boss', boss: 'juxing', rw: { gold: 380, M02: 5 }, unlock: '1-9', scene: 'snow' },
    { id: '2-1', ch: 2, n: '实验室入口', waves: 20, pool: ['putong', 'jipao', 'zibao', 'zhongjia'], per: [16, 25], mul: 1.55,
      cond: 'clear', rw: { gold: 360, M03: 8 }, unlock: '1-10', scene: 'tunnel' },
    { id: '2-2', ch: 2, n: '培养舱', waves: 20, pool: ['putong', 'jipao', 'zibao', 'zhongjia'], per: [16, 25], mul: 1.64,
      cond: 'clear', rw: { gold: 396, M03: 8 }, unlock: '2-1', scene: 'tunnel' },
    { id: '2-3', ch: 2, n: '通风管道', waves: 20, pool: ['putong', 'jipao', 'zibao', 'zhongjia'], per: [16, 25], mul: 1.74,
      cond: 'clear', rw: { gold: 432, M03: 8 }, unlock: '2-2', scene: 'tunnel' },
    { id: '2-4', ch: 2, n: '生化仓库', waves: 20, pool: ['putong', 'jipao', 'zibao', 'zhongjia'], per: [16, 25], mul: 1.83,
      cond: 'clear', rw: { gold: 468, M03: 8 }, unlock: '2-3', scene: 'tunnel' },
    { id: '2-5', ch: 2, n: '隔离区', waves: 20, pool: ['putong', 'jipao', 'zibao', 'zhongjia'], per: [16, 25], mul: 1.92,
      cond: 'clear', rw: { gold: 504, M03: 8 }, unlock: '2-4', scene: 'tunnel' },
    { id: '2-6', ch: 2, n: '样本室', waves: 20, pool: ['putong', 'jipao', 'zibao', 'zhongjia'], per: [16, 25], mul: 2.02,
      cond: 'clear', rw: { gold: 540, M03: 8 }, unlock: '2-5', scene: 'factory' },
    { id: '2-7', ch: 2, n: '地下二层', waves: 20, pool: ['putong', 'jipao', 'zibao', 'zhongjia'], per: [16, 25], mul: 2.11,
      cond: 'clear', rw: { gold: 576, M03: 8 }, unlock: '2-6', scene: 'tunnel' },
    { id: '2-8', ch: 2, n: '冷却机组', waves: 20, pool: ['putong', 'jipao', 'zibao', 'zhongjia'], per: [16, 25], mul: 2.2,
      cond: 'clear', rw: { gold: 612, M03: 8 }, unlock: '2-7', scene: 'field' },
    { id: '2-9', ch: 2, n: '排污通道', waves: 20, pool: ['putong', 'jipao', 'zibao', 'zhongjia'], per: [16, 25], mul: 2.29,
      cond: 'clear', rw: { gold: 648, M03: 8 }, unlock: '2-8', scene: 'snow' },
    { id: '2-10', ch: 2, n: 'BOSS·感染母体', waves: 20, pool: ['putong', 'jipao', 'zibao', 'zhongjia'], per: [16, 25], mul: 2.39,
      cond: 'boss', boss: 'mama', rw: { gold: 684, M03: 8 }, unlock: '2-9', scene: 'city' },
    { id: '3-1', ch: 3, n: '城市广场', waves: 20, pool: ['putong', 'jipao', 'zibao', 'zhongjia', 'du'], per: [19, 30], mul: 2.1,
      cond: 'clear', rw: { gold: 520, M04: 10 }, unlock: '2-10', scene: 'city' },
    { id: '3-2', ch: 3, n: '商业街', waves: 20, pool: ['putong', 'jipao', 'zibao', 'zhongjia', 'du'], per: [19, 30], mul: 2.23,
      cond: 'clear', rw: { gold: 572, M04: 10 }, unlock: '3-1', scene: 'city' },
    { id: '3-3', ch: 3, n: '地铁口', waves: 20, pool: ['putong', 'jipao', 'zibao', 'zhongjia', 'du'], per: [19, 30], mul: 2.35,
      cond: 'clear', rw: { gold: 624, M04: 10 }, unlock: '3-2', scene: 'city' },
    { id: '3-4', ch: 3, n: '钟楼', waves: 20, pool: ['putong', 'jipao', 'zibao', 'zhongjia', 'du'], per: [19, 30], mul: 2.48,
      cond: 'clear', rw: { gold: 676, M04: 10 }, unlock: '3-3', scene: 'city' },
    { id: '3-5', ch: 3, n: '桥梁防线', waves: 20, pool: ['putong', 'jipao', 'zibao', 'zhongjia', 'du'], per: [19, 30], mul: 2.6,
      cond: 'clear', rw: { gold: 728, M04: 10 }, unlock: '3-4', scene: 'city' },
    { id: '3-6', ch: 3, n: '市政厅', waves: 20, pool: ['putong', 'jipao', 'zibao', 'zhongjia', 'du'], per: [19, 30], mul: 2.73,
      cond: 'clear', rw: { gold: 780, M04: 10 }, unlock: '3-5', scene: 'tunnel' },
    { id: '3-7', ch: 3, n: '广播塔', waves: 20, pool: ['putong', 'jipao', 'zibao', 'zhongjia', 'du'], per: [19, 30], mul: 2.86,
      cond: 'clear', rw: { gold: 832, M04: 10 }, unlock: '3-6', scene: 'field' },
    { id: '3-8', ch: 3, n: '中央车站', waves: 20, pool: ['putong', 'jipao', 'zibao', 'zhongjia', 'du'], per: [19, 30], mul: 2.98,
      cond: 'clear', rw: { gold: 884, M04: 10 }, unlock: '3-7', scene: 'snow' },
    { id: '3-9', ch: 3, n: '立交桥', waves: 20, pool: ['putong', 'jipao', 'zibao', 'zhongjia', 'du'], per: [19, 30], mul: 3.11,
      cond: 'clear', rw: { gold: 936, M04: 10 }, unlock: '3-8', scene: 'city' },
    { id: '3-10', ch: 3, n: 'BOSS·双首', waves: 20, pool: ['putong', 'jipao', 'zibao', 'zhongjia', 'du'], per: [19, 30], mul: 3.23,
      cond: 'bossAll', boss: ['juxing','mama'], rw: { gold: 988, M04: 10 }, unlock: '3-9', scene: 'wasteland' },
    { id: '4-1', ch: 4, n: '厂房大门', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan'], per: [22, 35], mul: 2.65,
      cond: 'clear', rw: { gold: 680, M05: 12 }, unlock: '3-10', scene: 'factory' },
    { id: '4-2', ch: 4, n: '传送带', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan'], per: [22, 35], mul: 2.81,
      cond: 'clear', rw: { gold: 748, M05: 12 }, unlock: '4-1', scene: 'factory' },
    { id: '4-3', ch: 4, n: '熔炉车间', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan'], per: [22, 35], mul: 2.97,
      cond: 'clear', rw: { gold: 816, M05: 12 }, unlock: '4-2', scene: 'factory' },
    { id: '4-4', ch: 4, n: '装配线', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan'], per: [22, 35], mul: 3.13,
      cond: 'clear', rw: { gold: 884, M05: 12 }, unlock: '4-3', scene: 'factory' },
    { id: '4-5', ch: 4, n: '原料仓', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan'], per: [22, 35], mul: 3.29,
      cond: 'clear', rw: { gold: 952, M05: 12 }, unlock: '4-4', scene: 'factory' },
    { id: '4-6', ch: 4, n: '高压电房', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan'], per: [22, 35], mul: 3.45,
      cond: 'clear', rw: { gold: 1020, M05: 12 }, unlock: '4-5', scene: 'field' },
    { id: '4-7', ch: 4, n: '烟囱平台', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan'], per: [22, 35], mul: 3.6,
      cond: 'clear', rw: { gold: 1088, M05: 12 }, unlock: '4-6', scene: 'snow' },
    { id: '4-8', ch: 4, n: '废料场', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan'], per: [22, 35], mul: 3.76,
      cond: 'clear', rw: { gold: 1156, M05: 12 }, unlock: '4-7', scene: 'city' },
    { id: '4-9', ch: 4, n: '控制室', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan'], per: [22, 35], mul: 3.92,
      cond: 'clear', rw: { gold: 1224, M05: 12 }, unlock: '4-8', scene: 'wasteland' },
    { id: '4-10', ch: 4, n: 'BOSS·机械尸王', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan'], per: [22, 35], mul: 4.08,
      cond: 'boss', boss: 'juxing', rw: { gold: 1292, M05: 12 }, unlock: '4-9', scene: 'factory' },
    { id: '5-1', ch: 5, n: '田间小路', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun'], per: [25, 40], mul: 3.2,
      cond: 'clear', rw: { gold: 840, M01: 15 }, unlock: '4-10', scene: 'field' },
    { id: '5-2', ch: 5, n: '麦浪深处', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun'], per: [25, 40], mul: 3.39,
      cond: 'clear', rw: { gold: 924, M01: 15 }, unlock: '5-1', scene: 'field' },
    { id: '5-3', ch: 5, n: '风车谷仓', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun'], per: [25, 40], mul: 3.58,
      cond: 'clear', rw: { gold: 1008, M01: 15 }, unlock: '5-2', scene: 'field' },
    { id: '5-4', ch: 5, n: '灌溉渠', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun'], per: [25, 40], mul: 3.78,
      cond: 'clear', rw: { gold: 1092, M01: 15 }, unlock: '5-3', scene: 'field' },
    { id: '5-5', ch: 5, n: '农舍', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun'], per: [25, 40], mul: 3.97,
      cond: 'clear', rw: { gold: 1176, M01: 15 }, unlock: '5-4', scene: 'field' },
    { id: '5-6', ch: 5, n: '玉米地', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun'], per: [25, 40], mul: 4.16,
      cond: 'clear', rw: { gold: 1260, M01: 15 }, unlock: '5-5', scene: 'snow' },
    { id: '5-7', ch: 5, n: '晒谷场', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun'], per: [25, 40], mul: 4.35,
      cond: 'clear', rw: { gold: 1344, M01: 15 }, unlock: '5-6', scene: 'city' },
    { id: '5-8', ch: 5, n: '拖拉机场', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun'], per: [25, 40], mul: 4.54,
      cond: 'clear', rw: { gold: 1428, M01: 15 }, unlock: '5-7', scene: 'wasteland' },
    { id: '5-9', ch: 5, n: '围栏缺口', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun'], per: [25, 40], mul: 4.74,
      cond: 'clear', rw: { gold: 1512, M01: 15 }, unlock: '5-8', scene: 'factory' },
    { id: '5-10', ch: 5, n: 'BOSS·开垦者', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun'], per: [25, 40], mul: 4.93,
      cond: 'boss', boss: 'mama', rw: { gold: 1596, M01: 15 }, unlock: '5-9', scene: 'tunnel' },
    { id: '6-1', ch: 6, n: '辐射边界', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie'], per: [28, 45], mul: 3.75,
      cond: 'clear', rw: { gold: 1000, M02: 18 }, unlock: '5-10', scene: 'wasteland' },
    { id: '6-2', ch: 6, n: '焦土', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie'], per: [28, 45], mul: 3.98,
      cond: 'clear', rw: { gold: 1100, M02: 18 }, unlock: '6-1', scene: 'wasteland' },
    { id: '6-3', ch: 6, n: '掩体群', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie'], per: [28, 45], mul: 4.2,
      cond: 'clear', rw: { gold: 1200, M02: 18 }, unlock: '6-2', scene: 'wasteland' },
    { id: '6-4', ch: 6, n: '枯树林', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie'], per: [28, 45], mul: 4.42,
      cond: 'clear', rw: { gold: 1300, M02: 18 }, unlock: '6-3', scene: 'wasteland' },
    { id: '6-5', ch: 6, n: '沙暴区', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie'], per: [28, 45], mul: 4.65,
      cond: 'clear', rw: { gold: 1400, M02: 18 }, unlock: '6-4', scene: 'wasteland' },
    { id: '6-6', ch: 6, n: '战壕', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie'], per: [28, 45], mul: 4.88,
      cond: 'clear', rw: { gold: 1500, M02: 18 }, unlock: '6-5', scene: 'city' },
    { id: '6-7', ch: 6, n: '废弃坦克', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie'], per: [28, 45], mul: 5.1,
      cond: 'clear', rw: { gold: 1600, M02: 18 }, unlock: '6-6', scene: 'wasteland' },
    { id: '6-8', ch: 6, n: '观测站', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie'], per: [28, 45], mul: 5.32,
      cond: 'clear', rw: { gold: 1700, M02: 18 }, unlock: '6-7', scene: 'factory' },
    { id: '6-9', ch: 6, n: '辐射核心', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie'], per: [28, 45], mul: 5.55,
      cond: 'clear', rw: { gold: 1800, M02: 18 }, unlock: '6-8', scene: 'tunnel' },
    { id: '6-10', ch: 6, n: 'BOSS·巢穴之母', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie'], per: [28, 45], mul: 5.78,
      cond: 'boss', boss: 'juxing', rw: { gold: 1900, M02: 18 }, unlock: '6-9', scene: 'field' },
    { id: '7-1', ch: 7, n: '雪原前哨', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing'], per: [31, 50], mul: 4.3,
      cond: 'clear', rw: { gold: 1160, M03: 20 }, unlock: '6-10', scene: 'snow' },
    { id: '7-2', ch: 7, n: '冰封公路', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing'], per: [31, 50], mul: 4.56,
      cond: 'clear', rw: { gold: 1276, M03: 20 }, unlock: '7-1', scene: 'snow' },
    { id: '7-3', ch: 7, n: '补给站', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing'], per: [31, 50], mul: 4.82,
      cond: 'clear', rw: { gold: 1392, M03: 20 }, unlock: '7-2', scene: 'snow' },
    { id: '7-4', ch: 7, n: '雪松林', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing'], per: [31, 50], mul: 5.07,
      cond: 'clear', rw: { gold: 1508, M03: 20 }, unlock: '7-3', scene: 'snow' },
    { id: '7-5', ch: 7, n: '悬崖哨塔', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing'], per: [31, 50], mul: 5.33,
      cond: 'clear', rw: { gold: 1624, M03: 20 }, unlock: '7-4', scene: 'snow' },
    { id: '7-6', ch: 7, n: '冰湖', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing'], per: [31, 50], mul: 5.59,
      cond: 'clear', rw: { gold: 1740, M03: 20 }, unlock: '7-5', scene: 'wasteland' },
    { id: '7-7', ch: 7, n: '物资仓', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing'], per: [31, 50], mul: 5.85,
      cond: 'clear', rw: { gold: 1856, M03: 20 }, unlock: '7-6', scene: 'factory' },
    { id: '7-8', ch: 7, n: '风雪谷', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing'], per: [31, 50], mul: 6.11,
      cond: 'clear', rw: { gold: 1972, M03: 20 }, unlock: '7-7', scene: 'tunnel' },
    { id: '7-9', ch: 7, n: '雷达站', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing'], per: [31, 50], mul: 6.36,
      cond: 'clear', rw: { gold: 2088, M03: 20 }, unlock: '7-8', scene: 'field' },
    { id: '7-10', ch: 7, n: 'BOSS·冰霜领主', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing'], per: [31, 50], mul: 6.62,
      cond: 'boss', boss: 'mama', rw: { gold: 2204, M03: 20 }, unlock: '7-9', scene: 'snow' },
    { id: '8-1', ch: 8, n: '裂谷入口', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [34, 55], mul: 4.85,
      cond: 'clear', rw: { gold: 1320, M04: 22 }, unlock: '7-10', scene: 'tunnel' },
    { id: '8-2', ch: 8, n: '深渊阶梯', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [34, 55], mul: 5.14,
      cond: 'clear', rw: { gold: 1452, M04: 22 }, unlock: '8-1', scene: 'tunnel' },
    { id: '8-3', ch: 8, n: '溶洞', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [34, 55], mul: 5.43,
      cond: 'clear', rw: { gold: 1584, M04: 22 }, unlock: '8-2', scene: 'tunnel' },
    { id: '8-4', ch: 8, n: '地下暗河', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [34, 55], mul: 5.72,
      cond: 'clear', rw: { gold: 1716, M04: 22 }, unlock: '8-3', scene: 'tunnel' },
    { id: '8-5', ch: 8, n: '骨窟', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [34, 55], mul: 6.01,
      cond: 'clear', rw: { gold: 1848, M04: 22 }, unlock: '8-4', scene: 'tunnel' },
    { id: '8-6', ch: 8, n: '毒沼', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [34, 55], mul: 6.31,
      cond: 'clear', rw: { gold: 1980, M04: 22 }, unlock: '8-5', scene: 'factory' },
    { id: '8-7', ch: 8, n: '虫巢', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [34, 55], mul: 6.6,
      cond: 'clear', rw: { gold: 2112, M04: 22 }, unlock: '8-6', scene: 'tunnel' },
    { id: '8-8', ch: 8, n: '熔岩缝', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [34, 55], mul: 6.89,
      cond: 'clear', rw: { gold: 2244, M04: 22 }, unlock: '8-7', scene: 'field' },
    { id: '8-9', ch: 8, n: '深渊祭坛', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [34, 55], mul: 7.18,
      cond: 'clear', rw: { gold: 2376, M04: 22 }, unlock: '8-8', scene: 'snow' },
    { id: '8-10', ch: 8, n: 'BOSS·深渊领主', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [34, 55], mul: 7.47,
      cond: 'bossAll', boss: ['juxing','mama'], rw: { gold: 2508, M04: 22 }, unlock: '8-9', scene: 'city' },
    { id: '9-1', ch: 9, n: '母巢外壁', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [37, 60], mul: 5.4,
      cond: 'clear', rw: { gold: 1480, M05: 25 }, unlock: '8-10', scene: 'factory' },
    { id: '9-2', ch: 9, n: '孵化室', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [37, 60], mul: 5.72,
      cond: 'clear', rw: { gold: 1628, M05: 25 }, unlock: '9-1', scene: 'factory' },
    { id: '9-3', ch: 9, n: '黏液通道', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [37, 60], mul: 6.05,
      cond: 'clear', rw: { gold: 1776, M05: 25 }, unlock: '9-2', scene: 'factory' },
    { id: '9-4', ch: 9, n: '蛛网回廊', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [37, 60], mul: 6.37,
      cond: 'clear', rw: { gold: 1924, M05: 25 }, unlock: '9-3', scene: 'factory' },
    { id: '9-5', ch: 9, n: '卵室', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [37, 60], mul: 6.7,
      cond: 'clear', rw: { gold: 2072, M05: 25 }, unlock: '9-4', scene: 'factory' },
    { id: '9-6', ch: 9, n: '守卫巢', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [37, 60], mul: 7.02,
      cond: 'clear', rw: { gold: 2220, M05: 25 }, unlock: '9-5', scene: 'tunnel' },
    { id: '9-7', ch: 9, n: '菌毯', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [37, 60], mul: 7.34,
      cond: 'clear', rw: { gold: 2368, M05: 25 }, unlock: '9-6', scene: 'field' },
    { id: '9-8', ch: 9, n: '腐蚀池', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [37, 60], mul: 7.67,
      cond: 'clear', rw: { gold: 2516, M05: 25 }, unlock: '9-7', scene: 'snow' },
    { id: '9-9', ch: 9, n: '母巢前厅', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [37, 60], mul: 7.99,
      cond: 'clear', rw: { gold: 2664, M05: 25 }, unlock: '9-8', scene: 'city' },
    { id: '9-10', ch: 9, n: 'BOSS·修道士', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [37, 60], mul: 8.32,
      cond: 'boss', boss: 'mama', rw: { gold: 2812, M05: 25 }, unlock: '9-9', scene: 'wasteland' },
    { id: '10-1', ch: 10, n: '最后阵地', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [40, 65], mul: 5.95,
      cond: 'clear', rw: { gold: 1640, M01: 28 }, unlock: '9-10', scene: 'wasteland' },
    { id: '10-2', ch: 10, n: '断墙', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [40, 65], mul: 6.31,
      cond: 'clear', rw: { gold: 1804, M01: 28 }, unlock: '10-1', scene: 'wasteland' },
    { id: '10-3', ch: 10, n: '弹药库', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [40, 65], mul: 6.66,
      cond: 'clear', rw: { gold: 1968, M01: 28 }, unlock: '10-2', scene: 'wasteland' },
    { id: '10-4', ch: 10, n: '指挥所', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [40, 65], mul: 7.02,
      cond: 'clear', rw: { gold: 2132, M01: 28 }, unlock: '10-3', scene: 'wasteland' },
    { id: '10-5', ch: 10, n: '血色战壕', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [40, 65], mul: 7.38,
      cond: 'clear', rw: { gold: 2296, M01: 28 }, unlock: '10-4', scene: 'wasteland' },
    { id: '10-6', ch: 10, n: '残破街垒', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [40, 65], mul: 7.74,
      cond: 'clear', rw: { gold: 2460, M01: 28 }, unlock: '10-5', scene: 'field' },
    { id: '10-7', ch: 10, n: '终末广场', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [40, 65], mul: 8.09,
      cond: 'clear', rw: { gold: 2624, M01: 28 }, unlock: '10-6', scene: 'snow' },
    { id: '10-8', ch: 10, n: '人类旗帜', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [40, 65], mul: 8.45,
      cond: 'clear', rw: { gold: 2788, M01: 28 }, unlock: '10-7', scene: 'city' },
    { id: '10-9', ch: 10, n: '黎明前夜', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [40, 65], mul: 8.81,
      cond: 'clear', rw: { gold: 2952, M01: 28 }, unlock: '10-8', scene: 'wasteland' },
    { id: '10-10', ch: 10, n: 'BOSS·尸王', waves: 20, pool: ['putong', 'jipao', 'zhongjia', 'du', 'tuye', 'zhadan', 'dun', 'fenlie', 'feixing', 'jinying'], per: [40, 65], mul: 9.16,
      cond: 'boss', boss: 'juxing', rw: { gold: 3116, M01: 28 }, unlock: '10-9', scene: 'factory' },
  ],
   ...
   * =================================================== */
  zombies: [
    { id: 'putong', n: '普通僵尸', icon: '🧟', img: 'assets/icon/z_putong.jpg', hp: 30, spd: 34, dmg: 8, atkR: 26, ai: 'chase', armor: 0,
      skill: '扑咬', sk: '近战伤害，靠近玩家撕咬', xp: 4, gold: 3 },
    { id: 'jipao', n: '疾跑僵尸', icon: '🏃', img: 'assets/icon/z_jipao.jpg', hp: 22, spd: 78, dmg: 14, atkR: 24, ai: 'rush', armor: 0,
      skill: '冲刺', sk: '高速冲向玩家，接触造成高伤害', xp: 6, gold: 4 },
    { id: 'zhongjia', n: '重甲僵尸', icon: '🥋', img: 'assets/icon/z_zhongjia.jpg', hp: 180, spd: 26, dmg: 18, atkR: 28, ai: 'chase', armor: 15,
      skill: '护甲', sk: '减伤高，需穿透/爆炸破甲', def: 0.55, xp: 14, gold: 12, elite: true },
    { id: 'zibao', n: '自爆僵尸', icon: '💣', img: 'assets/icon/z_zibao.jpg', hp: 45, spd: 62, dmg: 34, atkR: 30, ai: 'boomer', armor: 0,
      skill: '自爆', sk: '接近后自爆，范围伤害，死亡解体', xp: 10, gold: 8 },
    { id: 'du', n: '毒僵尸', icon: '☠️', img: 'assets/icon/z_du.jpg', hp: 90, spd: 34, dmg: 10, atkR: 120, ai: 'ranged', armor: 5,
      skill: '毒雾', sk: '喷洒毒雾，玩家中毒持续掉血', poison: 6, xp: 13, gold: 10, elite: true },
    { id: 'tuye', n: '吐液僵尸', icon: '🤮', img: 'assets/icon/z_tuye.jpg', hp: 70, spd: 30, dmg: 12, atkR: 150, ai: 'ranged', armor: 0,
      skill: '腐蚀液', sk: '远程喷吐，落地区域持续伤害', pool: 5, xp: 12, gold: 9 },
    { id: 'zhadan', n: '炸弹僵尸', icon: '🧨', img: 'assets/icon/z_zhadan.jpg', hp: 55, spd: 44, dmg: 26, atkR: 28, ai: 'boomer', armor: 0,
      skill: '死亡爆炸', sk: '死亡时爆炸范围伤害，可引爆油桶', xp: 11, gold: 9 },
    { id: 'dun', n: '护盾僵尸', icon: '🔰', img: 'assets/icon/z_dun.jpg', hp: 130, spd: 32, dmg: 16, atkR: 26, ai: 'chase', armor: 10,
      skill: '能量护盾', sk: '正面免疫伤害，需绕后或破盾', front: 0.85, xp: 16, gold: 13, elite: true },
    { id: 'fenlie', n: '分裂僵尸', icon: '🪱', img: 'assets/icon/z_fenlie.jpg', hp: 85, spd: 36, dmg: 12, atkR: 26, ai: 'chase', armor: 0,
      skill: '分裂', sk: '死亡分裂成 2 个小僵尸', split: 2, xp: 12, gold: 10 },
    { id: 'feixing', n: '飞行僵尸', icon: '🦅', img: 'assets/icon/z_feixing.jpg', hp: 60, spd: 58, dmg: 15, atkR: 30, ai: 'chase', armor: 0,
      skill: '飞行', sk: '越过地面障碍，空中移动', fly: true, xp: 13, gold: 11 },
    { id: 'jinying', n: '精英僵尸', icon: '👹', img: 'assets/icon/z_jinying.jpg', hp: 320, spd: 40, dmg: 26, atkR: 30, ai: 'chase', armor: 5,
      skill: '强化体魄', sk: '高血量高伤害的精英单位', def: 0.3, xp: 30, gold: 26, elite: true },
    { id: 'xiaozombie', n: '小僵尸', icon: '🐛', img: 'assets/icon/z_xiaozombie.jpg', hp: 12, spd: 50, dmg: 5, atkR: 20, ai: 'chase', armor: 0,
  ...
  shopGoods: {
    ...
    '直购': [
      ...
      { id: 'SH02', n: '钻石小包', icon: '💎', price: 60, cur: 'diamond', rmb: '6元',
      ...
      { id: 'SH05', n: '月卡', icon: '📅', price: 300, cur: 'diamond', rmb: '30元',
        give: {}, monthly: true, limit: { t: 'monthly', v: 1 },
        desc: '每日领 钻石50 + 体力60（30天）' },
      { id: 'SH06', n: '战令(普通)', icon: '🎖️', price: 0, cur: 'gold', rmb: '免费',
        give: {}, pass: 'normal', desc: '按等级免费领奖励' },
      { id: 'SH07', n: '战令(进阶)', icon: '🎖️', price: 680, cur: 'diamond', rmb: '68元',
